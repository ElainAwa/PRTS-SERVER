...
public final class PaperAdventure {
    ...
    public static net.minecraft.network.chat.Component asVanilla(@NotNull Component component) {
        try {
            ...
            return net.minecraft.network.chat.Component.Serializer.fromJson(json, net.minecraft.core.RegistryAccess.EMPTY);
        } catch (Exception e) {
    ...
    public static @NotNull Component asAdventure(@NotNull net.minecraft.network.chat.Component component) {
        try {
            String json = net.minecraft.network.chat.Component.Serializer.toJson(component, net.minecraft.core.RegistryAccess.EMPTY);
