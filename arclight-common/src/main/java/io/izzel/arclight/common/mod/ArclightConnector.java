...
public class ArclightConnector implements IMixinConnector {
    ...
    public void connect() {
        ...
        Mixins.addConfiguration("mixins.arclight.impl.forge.ticketpropagator.json");
        LOGGER.info("mixin-load.ticketpropagator");
        Mixins.addConfiguration("mixins.arclight.impl.forge.chunkwatching.json");
        LOGGER.info("mixin-load.chunkwatching");
        Mixins.addConfiguration("mixins.arclight.impl.forge.nearbyplayers.json");
        LOGGER.info("mixin-load.nearbyplayers");
    }
}
