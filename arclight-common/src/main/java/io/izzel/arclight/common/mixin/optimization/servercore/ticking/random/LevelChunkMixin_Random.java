...
package io.izzel.arclight.common.mixin.optimization.servercore.ticking.random;

import io.izzel.arclight.common.optimization.servercore.ticking.ILevelChunk;
 ...
 * 偏差：上游用 Level.threadSafeRandom（1.21.1 为 private），此处改用 ThreadLocalRandom，分布等价且免开放字段。
 */
